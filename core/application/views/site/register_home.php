<script type="text/javascript" src="<?php echo site_url('assets/site/js/register_home.js')?>"></script>
<style>
hr{
...
<div class="mastermain">
    <div class="login">
    	<div class="title"><strong>حساب کاربری</strong> <strong class="t" style="display:none">سپردن ملک</strong></div>
		<div class='control'>
           <?php
			$class = NULL;
			 $uri = $this->uri->segment(1); 
			if($uri == 'register_home'){
				$class ='active';
				}
			?>
        	<div class="row"><a href="<?php echo site_url('profile')?>">حساب کاربری</a></div>
        	<div class="row <?php echo $class?>"><a href="<?php echo site_url('register_home')?>">ثبت ملک</a></div> 
        ...
        <?php echo form_open_multipart('register_home/save','id="form"');?>
...
<tr>
<td>
<input type="radio" name="ads" value="1"  checked="checked"/> : آگهی رایگان
<input type="radio" name="ads" value="2" /> : آگهی ویژه
...
<tr>
<td>
<input type="button"  id="saveHome" value="ثبت اطلاعات" >
</td>
</tr>
</table>
<?php echo form_close();?>
