...
class MY_Model extends CI_Model {
	...
	public function group_by($where, $group ,$sort = NULL){
		$this->db->group_by($group);
		return $this->get_by($where, $sort, $limit = NULL, $offset = NULL);
		}
	...
	public function save_by($data, $where, $offset = NULL){
	...
	public function count_db_results($where){
					$this->db->where($where);
